...
last_modified_at: 2025-03-05 05:06:00 +0800
...
```markdown
![Desktop View](/assets/img/posts/tutorial_mockup.png){: width="700" height="400" }
```
{: .nolineno}
...
```markdown
![Desktop View](/assets/img/posts/tutorial_mockup.png){: w="700" h="400" }
```
{: .nolineno}
...
- **Normal position**
  ...
  ```markdown
  ![Desktop View](/assets/img/posts/tutorial_mockup.png){: .normal }
  ```
  {: .nolineno}
...
- **Float to the left**
  ...
  ```markdown
  ![Desktop View](/assets/img/posts/tutorial_mockup.png){: .left }
  ```
  {: .nolineno}
...
- **Float to the right**
  ...
  ```markdown
  ![Desktop View](/assets/img/posts/tutorial_mockup.png){: .right }
  ```
  {: .nolineno}
