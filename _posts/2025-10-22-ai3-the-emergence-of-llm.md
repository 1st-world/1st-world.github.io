...
다음 [4부 - LLM을 더 똑똑하게 만드는 RAG & RLHF](/posts/rag-rlhf-make-llm-smarter/)에서는 이러한 LLM의 한계점을 '스케일링'이 아닌 다른 방식으로 극복하려는 기술들, **RAG(검색 증강 생성)** 및 **RLHF(인간 피드백을 통한 강화 학습)** 등에 관해 알아보도록 하겠습니다.
