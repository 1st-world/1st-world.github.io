...
last_modified_at: 2025-10-20 23:35:00 +0900
categories: [Cloud]
...
- **가벼움과 빠른 속도:** 게스트 OS가 없으므로 이미지의 크기가 매우 작습니다. VM은 부팅에 수 분이 걸리는 반면, 컨테이너는 일반적으로 단 몇 초 만에 시작하고 중지할 수 있습니다.

- **효율적인 자원 활용:** 하나의 호스트 컴퓨터에 훨씬 더 많은 수의 컨테이너를 실행할 수 있어 서버 자원을 집약적으로 사용할 수 있습니다.
